...
workflow_definition!(
    ...
    actions: [
        ...
        action!("deploy_broadcast", true, "post_projects_project_id_releases_release_id_deploy", "pcl releases calldata deploy <project-ref> <release-id> --broadcast --private-key <key> --rpc-url <url> --yes", required: ["<project-ref>", "<release-id>", "--broadcast"], optional: ["--private-key", "--account", "--keystore-password-file", "--rpc-url", "--confirmations", "--yes", "--signer-address"], side_effect: "onchain_transaction"),
        ...
        action!("remove_broadcast", true, "post_projects_project_id_releases_release_id_remove", "pcl releases calldata remove <project-ref> <release-id> --broadcast --private-key <key> --rpc-url <url> --yes", required: ["<project-ref>", "<release-id>", "--broadcast"], optional: ["--private-key", "--account", "--keystore-password-file", "--rpc-url", "--confirmations", "--yes"], side_effect: "onchain_transaction"),
