...
workflow_definition!(
    ...
    actions: [
        ...
        action!("transfer_broadcast", true, "get_projects_project_id_protocol_manager_transfer_calldata", "pcl protocol-manager --project <project-ref> --transfer-calldata --new-manager 0x... --broadcast --private-key <key> --rpc-url <url> --yes", required: ["--project", "--new-manager", "--broadcast"], optional: ["--private-key", "--account", "--keystore-password-file", "--rpc-url", "--confirmations", "--yes"], query: {"new_manager" => "<address>"}),
        ...
        action!("accept_broadcast", true, "post_projects_project_id_protocol_manager_confirm_transfer", "pcl protocol-manager --project <project-ref> --accept-calldata --broadcast --private-key <key> --rpc-url <url> --yes", required: ["--project", "--broadcast"], optional: ["--private-key", "--account", "--keystore-password-file", "--rpc-url", "--confirmations", "--yes"]),
